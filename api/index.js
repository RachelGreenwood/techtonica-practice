...
const grabRandomBeer = () => {
    ...
    fetch("https://api.punkapi.com/v2/beers/random")
      ...
      .then(beers => {
        ...
        vol.textContent = `Volume: ${beer.volume.value} ${beer.volume.unit}`;
        const first = document.createElement("p");
        first.textContent = `First brewed on ${beer.first_brewed}`;
        ...
        beerElement.appendChild(vol)
        beerElement.appendChild(first);
      })
      .catch(err => {
